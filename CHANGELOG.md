# [](https://github.com/rhlowery/access-control-service/compare/v1.0.0...v) (2026-06-11)


### Bug Fixes

* **#57:** Issue S3 - CORS allows wildcard origins in production ([8ec99fb](https://github.com/rhlowery/access-control-service/commit/8ec99fb0269ac5b480ad8485466855194bf84e43)), closes [#57](https://github.com/rhlowery/access-control-service/issues/57) [#57](https://github.com/rhlowery/access-control-service/issues/57)
...
* Confirm Jacoco Coverage for New Validation Paths ([4fab5ab](https://github.com/rhlowery/access-control-service/commit/4fab5ab55719229ee9baf8555859b2f896e3e566)), closes [#6](https://github.com/rhlowery/access-control-service/issues/6)
...
* **Issue DU - 69:** Duplicate Javadoc block on AccessRequestResource ([3185da7](https://github.com/rhlowery/access-control-service/commit/3185da7b491f19bc1644cae3d2ea9b081862eb6c)), closes [#69](https://github.com/rhlowery/access-control-service/issues/69)
* **Issue S1:** TokenService.generateToken() NPE on null role ([7140dbc](https://github.com/rhlowery/access-control-service/commit/7140dbcd03052698df254239ed9202672ade8677)), closes [#55](https://github.com/rhlowery/access-control-service/issues/55)
* **Issue S2:** OIDC callback hardcodes identity — no real token exchange ([4c95c2f](https://github.com/rhlowery/access-control-service/commit/4c95c2ff52ea1211b3da412de76ba82e332ad7eb)), closes [#56](https://github.com/rhlowery/access-control-service/issues/56)
* **openapi:** enforce OpenAPI documentation standards and update field examples across DTOs and domain models ([e9fac8a](https://github.com/rhlowery/access-control-service/commit/e9fac8a3a5b3d69130094ac6633e6c89712ddcd8))
...
* **test:** mock OidcClient in AuthResourceCoverageTest and OidcCallbackTest to validate token handling ([bb151ba](https://github.com/rhlowery/access-control-service/commit/bb151ba85caf95fdbc0d0644679650fc133a0900))


### Features

* default role to STANDARD_USER in TokenService and refactor StabilityCoverageTest for improved branch coverage ([e17c66f](https://github.com/rhlowery/access-control-service/commit/e17c66fd470d6251d287031267c3f4e3ec11c969))
* implement OIDC authorization code flow with state-based CSRF protection and token exchange support ([1fdf384](https://github.com/rhlowery/access-control-service/commit/1fdf384ae421afbaaae744185afd1d94a063cba9))
