...
describe('UserService', () => {
  ...
  it('fetches users successfully', async () => {
    ...
    (global.fetch as any).mockResolvedValueOnce(mockResponse(mockData));
  ...
  it('handles fetch users error', async () => {
    (global.fetch as any).mockResolvedValueOnce(mockResponse(null, false));
  ...
  it('assigns user persona successfully', async () => {
    (global.fetch as any).mockResolvedValueOnce(mockResponse({ success: true }));
