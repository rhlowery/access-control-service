...
public class UiLogRequest {
    ...
    @Schema(description = "The log level (e.g., info, warn, error)", examples = {"error"}, required = true)
    public String level;

    @Schema(description = "The descriptive log message", examples = {"Failed to load identity providers"}, required = true)
