 ...
 * Personas are used to drive UI capabilities and security logic.
 *
 * [Persona system-wide definition and assignment hierarchy]
 */
...
public record Persona(
  ...
  /**
   * Returns a list of all predefined system personas.
   *
