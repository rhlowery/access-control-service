...
/**
 * Service for emitting data lineage events using the OpenLineage standard.
 * Integrates with the {@link AccessRequest} lifecycle to track permissions drift.
 *
 * [PlantUML: OpenLineage event emission sequence for access requests]
 */
@ApplicationScoped
public class LineageService {
  ...
  /**
   * Emits a RunEvent to the OpenLineage transport (default: Console).
   *
   * @param request The access request being tracked
   * @param type The type of event or user identifier associated with the change
   */
